  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="消息类型" prop="type">
        ...
        >
          <el-option
            v-for="dict in this.getDictDatas(DICT_TYPE.MP_MESSAGE_TYPE)"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="内容" prop="content">
        <template v-slot="scope">
          <!-- 【事件】区域 -->
          <div
            v-if="scope.row.type === 'event' && scope.row.event === 'subscribe'"
          >
            <el-tag type="success" size="mini">关注</el-tag>
          </div>
          <div
            v-else-if="
              scope.row.type === 'event' && scope.row.event === 'unsubscribe'
            "
          >
          ...
          <div
            v-else-if="scope.row.type === 'event' && scope.row.event === 'VIEW'"
          >
          ...
          <div
            v-else-if="
              scope.row.type === 'event' &&
              scope.row.event === 'scancode_waitmsg'
            "
          >
          ...
          <div
            v-else-if="
              scope.row.type === 'event' && scope.row.event === 'pic_weixin'
            "
          >
          ...
          <div
            v-else-if="
              scope.row.type === 'event' &&
              scope.row.event === 'location_select'
            "
          >
          ...
          <div v-else-if="scope.row.type === 'voice'">
            <wx-voice-player
              :url="scope.row.mediaUrl"
              :content="scope.row.recognition"
            />
          </div>
          ...
          <div
            v-else-if="
              scope.row.type === 'video' || scope.row.type === 'shortvideo'
            "
          >
            <wx-video-player
              :url="scope.row.mediaUrl"

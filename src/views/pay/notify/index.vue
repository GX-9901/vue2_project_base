  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="通知类型" prop="type">
        ...
        >
          <el-option
            v-for="dict in this.getDictDatas(DICT_TYPE.PAY_NOTIFY_TYPE)"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
      ...
      <el-form-item label="通知状态" prop="status">
        ...
        >
          <el-option
            v-for="dict in this.getDictDatas(DICT_TYPE.PAY_NOTIFY_STATUS)"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    >
      ...
      <el-descriptions :column="2" label-class-name="desc-label">
        <el-descriptions-item label="最后通知时间">{{
          parseTime(notifyDetail.lastExecuteTime)
        }}</el-descriptions-item>
        <el-descriptions-item label="下次通知时间">{{
          parseTime(notifyDetail.nextNotifyTime)
        }}</el-descriptions-item>
      </el-descriptions>
      <el-descriptions :column="2" label-class-name="desc-label">
        <el-descriptions-item label="创建时间">{{
          parseTime(notifyDetail.createTime)
        }}</el-descriptions-item>
        <el-descriptions-item label="更新时间">{{
          parseTime(notifyDetail.updateTime)
        }}</el-descriptions-item>
      </el-descriptions>
      <!-- 分割线 -->
      <el-divider />

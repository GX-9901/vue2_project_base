  ...
  <div class="app-container">
    ...
    >
      <el-form-item label="错误码类型" prop="type">
        ...
        >
          <el-option
            v-for="dict in this.getDictDatas(DICT_TYPE.SYSTEM_ERROR_CODE_TYPE)"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
  ...
  data() {
    return {
      ...
      rules: {
        ...
        code: [
          { required: true, message: "错误码编码不能为空", trigger: "blur" },
        ],
        message: [
          { required: true, message: "错误码提示不能为空", trigger: "blur" },
        ],
      },
    };
  },

  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="发送状态" prop="sendStatus">
        ...
        >
          <el-option
            v-for="dict in this.getDictDatas(DICT_TYPE.SYSTEM_MAIL_SEND_STATUS)"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
      ...
      <el-form ref="form" :model="form" label-width="160px">
        <el-row>
          <el-col :span="24">
            ...
            <el-form-item label="发送返回的消息编号：">{{
              form.sendMessageId
            }}</el-form-item>
            <el-form-item label="发送异常：">{{
              form.sendException
            }}</el-form-item>
          </el-col>
        </el-row>

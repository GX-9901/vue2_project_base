  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="用户类型" prop="userType">
        ...
        >
          <el-option
            v-for="dict in this.getDictDatas(DICT_TYPE.USER_TYPE)"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
      ...
      >
        <template v-slot="scope">
          ...
          <el-button
            ...
            icon="el-icon-check"
            v-if="
              scope.row.processStatus === InfApiErrorLogProcessStatusEnum.INIT
            "
            v-hasPermi="['infra:api-error-log:update-status']"
            @click="
              handleProcessClick(
                scope.row,
                InfApiErrorLogProcessStatusEnum.DONE,
              )
            "
            >已处理</el-button
          >
          <el-button
            ...
            @click="
              handleProcessClick(
                scope.row,
                InfApiErrorLogProcessStatusEnum.IGNORE,
              )
            "
            >已忽略</el-button
          >
          ...
          <el-col :span="24">
            ...
            <el-form-item label="异常名">
              <el-input
                ...
                :readonly="true"
                :autosize="{ maxRows: 20 }"
                v-model="form.exceptionStackTrace"
              ></el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleProcessClick(row, processStatus) {
      const processStatusText = this.getDictDataLabel(

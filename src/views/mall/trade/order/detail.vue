  ...
  <div class="app-container order-detail-page">
    ...
    <template v-for="(group, index) in detailGroups">
      ...
      >
        <!-- 订单操作日志 -->
        <el-descriptions-item
          v-if="group.key === 'orderLog'"
          labelClassName="no-colon"
        >
          <el-timeline>
            <el-timeline-item
        ...
        <!-- 物流信息 -->
        <el-descriptions-item
          v-if="group.key === 'expressInfo'"
          labelClassName="no-colon"
        >
          <el-tabs type="card">
            <!-- 循环包裹物流信息 -->
            <el-tab-pane
              v-for="(pkgInfo, pInIdx) in detailInfo[group.key]"
              :key="`pkgInfo_${pInIdx}`"
              :label="pkgInfo.label"
            >
              <!-- 包裹详情 -->
              <el-descriptions>
                ...
                >
                  ...
                  <template
                    v-if="
                      pkgChild.valueKey === 'goodsList' &&
                      pkgInfo[pkgChild.valueKey]
                    "
                  >
                    <div
                      v-for="(goodInfo, goodInfoIdx) in pkgInfo[
                        pkgChild.valueKey
                      ]"

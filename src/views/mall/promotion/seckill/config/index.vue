    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['promotion:seckill-time:create']"
          >新增秒杀时段</el-button
        >
      </el-col>
      <right-toolbar
      ...
      >
        <template v-slot="scope">
          <el-button
            ...
            type="text"
            icon="el-icon-view"
            @click="handleOpenSeckillActivity(scope.row)"
          >
            查看秒杀活动</el-button
          >
          <el-button
            ...
            v-hasPermi="['promotion:seckill-time:update']"
            >修改</el-button
          >
          <el-button
            size="mini"
            ...
            v-hasPermi="['promotion:seckill-time:delete']"
            >删除</el-button
          >
        </template>
      </el-table-column>
...
import {
  ...
  getSeckillTime,
  getSeckillTimePage,
  exportSeckillTimeExcel,
  getSeckillTimeList,
} from "@/api/mall/promotion/seckillTime";
  ...
  data() {
    return {
      ...
      rules: {
        ...
        startAndEndTime: [
          { required: true, message: "秒杀时间段不能为空", trigger: "blur" },
        ],
      },
    };
  },

      ...
      >
        <template v-slot="scope">
          ...
          <el-button
            ...
            v-if="
              scope.row.status !== PromotionActivityStatusEnum.CLOSE.type &&
              ...
              <template v-slot="scope">
                <el-form-item
                  v-if="
                    ...
                    PromotionDiscountTypeEnum.PRICE.type
                  "
                  prop="discountPrice"
                >
                  减
                  <el-input-number
                    ...
                    :precision="2"
                    :min="0"
                    :max="scope.row.price / 100.0 - 0.01"
                  />
                  元
                </el-form-item>
                <el-form-item
                  v-if="
                    scope.row.discountType ===
                    PromotionDiscountTypeEnum.PERCENT.type
                  "
                  prop="discountPercent"
                >
                  打
                  <el-input-number
                    v-model="scope.row.discountPercent"
                    placeholder="请输入优惠折扣"
                    style="width: 190px"
                    :precision="1"
                    :min="1"
